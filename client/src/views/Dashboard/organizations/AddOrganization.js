...
import { createOrganization } from '../../../redux/actions/apiActions'
...
const AddOrganization = () => {
    ...
    const handleOnSubmit = async (values) => {
        ...
        try {
            await createOrganization(role, values);
            ...
            toast.error(error.response.data.msg ?? "some error occured while creating Organization");
        }
    }
