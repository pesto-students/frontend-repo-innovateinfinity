...
import { createAdmin } from '../../../redux/actions/apiActions'
...
const AddAdmin = () => {
    ...
    const handleOnSubmit = async (values) => {
        ...
        try {
            await createAdmin(role, values, query);
            ...
            toast.error(error.response.data.message ?? "some error occured while creating admin");
        }
    }
